...
# Trade Misinvoicing, Capital Flight, and Macroeconomic Distortions in Bangladesh: An Explainable AI and Social Science Analysis
...
This repository contains the research materials for the manuscript on trade misinvoicing, capital flight, and macroeconomic distortions in Bangladesh, combining an explainable AI framework with social science analysis.
...
**Manuscript & Research Content** — Licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)
Allows sharing and adaptation with attribution.

**Code & Scripts** — Licensed under [MIT License](https://opensource.org/licenses/MIT)
